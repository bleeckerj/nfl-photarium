...
export async function uploadImage({ apiBase, filePath, namespace, folder, createFolder, tags, description, displayName, sourcePath, originalUrl, duplicateAction, semanticTagCount }) {
