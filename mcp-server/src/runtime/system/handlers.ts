...
export const systemHandlers: Record<string, RuntimeToolHandler> = {
  ...
  'photarium_generate_embeddings': async (args: Record<string, unknown>) => {
  ...
  'photarium_embedding_status': async (args: Record<string, unknown>) => {
  ...
  'photarium_embeddings_batch': async (args: Record<string, unknown>) => {
  ...
  'photarium_colors_bulk': async (args: Record<string, unknown>) => {
  ...
  'photarium_audit': async (args: Record<string, unknown>) => {
  ...
  'photarium_backup': async (args: Record<string, unknown>) => {
