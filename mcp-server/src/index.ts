...
async function searchImages(query: string, limit: number = 20): Promise<SearchResult> {
...
const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search for images using natural language. Uses CLIP embeddings for semantic search. Good for finding images by concept, subject, mood, or visual characteristics.',
    inputSchema: {
      type: 'object',
      properties: {
        query: {
  ...
  },
  {
    ...
    description:
      'Search for images by dominant color. Finds images that prominently feature the specified color in their palette.',
    inputSchema: {
      type: 'object',
      properties: {
        color: {
  ...
  },
  {
    name: 'photarium_list',
    description:
      'List images from the gallery with optional filtering by folder or namespace.',
    inputSchema: {
      type: 'object',
      properties: {
        folder: {
