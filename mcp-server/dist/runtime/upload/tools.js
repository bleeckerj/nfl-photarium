export const uploadTools = [
    ...
    },
    {
        ...
        description: 'Create a width-preserving aspect-ratio crop from a Photarium image original and upload it as a variant. Supports still images and animated WebP/GIF sources; outputs WebP.',
        inputSchema: {
            type: 'object',
            properties: {
                imageId: {
