const imageToolRequestSchema = {
    type: 'object',
    description: 'Partial image-tool request override. Omitted fields are filled from the selected tool manifest defaultRequest.',
    properties: {
        effectId: {
            type: 'string',
...
export const imageToolTools = [
    ...
    },
    {
        ...
        description: 'Start an asynchronous Photarium image-tool run for an image and return the created run record.',
        inputSchema: {
            type: 'object',
            properties: {
                toolId: {
    ...
    },
    {
        ...
        description: 'Start an asynchronous Photarium image-tool preview for an image and return the created preview record.',
        inputSchema: {
            type: 'object',
            properties: {
                toolId: {
