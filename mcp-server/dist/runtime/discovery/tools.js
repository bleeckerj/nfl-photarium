export const discoveryTools = [
    ...
    },
    {
        ...
        description: 'Field-aware metadata search across image fields: filename, folder, tags, description, alt text, namespace, and source/original URLs. Unlike photarium_search_text (which substring-scans every field at once), this lets you target specific fields, pick a match mode (contains, exact, prefix, regex), toggle case sensitivity, and see which fields matched each result. Best for precise filename or field-scoped lookups (e.g., files whose filename starts with "hero-", or an exact tag).',
        inputSchema: {
            type: 'object',
            properties: {
                query: {
