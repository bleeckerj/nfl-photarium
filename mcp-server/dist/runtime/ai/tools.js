export const aiTools = [
    ...
    },
    {
        ...
        inputSchema: {
            ...
            properties: {
                ...
                folder: { type: 'string', description: 'Existing Photarium folder for the generated image. Rejected unless it exists or createFolder is set.' },
                createFolder: { type: 'boolean', description: 'Operator authorization to create the folder if it does not exist. Defaults to false; do not set on your own initiative — reuse an existing folder or ask the operator.' },
    ...
    },
    {
        ...
        description: 'Use OpenAI image editing to change a Photarium image ID or direct image URL to a target aspect ratio without cropping, stretching, or padding, then upload the result as a variant when a source image ID is provided.',
        inputSchema: {
            type: 'object',
            properties: {
                imageId: {
                ...
                folder: { type: 'string', description: 'Existing Photarium folder for the generated variant. Rejected unless it exists or createFolder is set.' },
                createFolder: { type: 'boolean', description: 'Operator authorization to create the folder if it does not exist. Defaults to false; do not set on your own initiative — reuse an existing folder or ask the operator.' },
