...
export declare function generatePhotariumImageFromReferences(deps: ImageGenerationDeps, settings: ImageGenerationSettings, references: ImageReferenceInput[], mode?: 'reference_generate' | 'semantic_merge'): Promise<Record<string, unknown>>;
export {};
