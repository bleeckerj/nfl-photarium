...
const parseProject = (value: unknown): ClientPageProjectRecord | null => {
  ...
  return {
    ...
    accessPolicy: value.accessPolicy as ClientPageProjectRecord['accessPolicy'],
    visibleTagPolicy: value.visibleTagPolicy as ClientPageProjectRecord['visibleTagPolicy'],
    downloadPresetPolicy: value.downloadPresetPolicy as ClientPageProjectRecord['downloadPresetPolicy'],
