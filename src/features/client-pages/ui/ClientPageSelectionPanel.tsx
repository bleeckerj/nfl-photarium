  ...
  return (
    <section className="rounded-md border border-stone-200 bg-white p-4">
      <div className="border-b border-stone-200 pb-4">
        <p className="text-[11px] font-mono uppercase tracking-[0.24em] text-stone-500">Selected images</p>
        <p className="mt-1 text-sm text-stone-600">{selectedImages.length} assets in this client page.</p>
      </div>

      {selectedImages.length === 0 ? (
        <p className="py-6 text-sm text-stone-500">No images selected yet.</p>
      ) : (
