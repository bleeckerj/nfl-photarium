...
import { Copy, ExternalLink, Sparkles, Layers, AlertTriangle, Trash2 } from 'lucide-react';
...
import { SearchExclusionIcon } from './icons/SearchExclusionIcon';
import { getExclusionTooltip, hasSearchExclusionTag, isSvgImage } from './utils';
        ...
        return (
          ...
          >
            ...
            <div id="metadata-footer" className="px-3 py-2 bg-white border-t border-gray-100 flex-1 flex flex-col">
              ...
              <div className="pt-2">
                <button
                  onClick={(e) => { e.stopPropagation(); onGenerateAlt(image.id); }}
            ...
            <div className="flex flex-wrap justify-center gap-1.5 py-1.5 bg-white border-b border-gray-200 z-30 mt-auto">
              <button
                onClick={(e) => { e.stopPropagation(); onToggleCopyMenu(image.id); }}
