...
export const ImageCard: React.FC<ImageCardProps> = ({
  ...
  return (
    <div
      ...
      // scrollMarginTop pairs with scrollIntoView({ block: 'start' }) so the
      // focused tile lands cleanly below the sticky gallery header instead of
      // colliding with it.
      style={isFocusedInGallery ? { scrollMarginTop: '6rem' } : undefined}
      className={`relative z-0 group bg-gray-100 rounded-lg overflow-hidden flex flex-col h-full border ${
