...
import GalleryHiddenInventory, { getHiddenVisibilityCount } from './GalleryHiddenInventory';
...
export default function GalleryUtilityRail({
  ...
  const hiddenVisibilityCount = getHiddenVisibilityCount({ hiddenFolders, hiddenTags, hiddenNamespaces });

  return (
    <div
      className="hidden sm:block fixed right-4 top-1/2 -translate-y-1/2 z-[3000]"
    >
      {!expanded && hiddenVisibilityCount > 0 && (
        <GalleryHiddenInventory
          hiddenFolders={hiddenFolders}
          hiddenTags={hiddenTags}
          hiddenNamespaces={hiddenNamespaces}
          onClearHiddenFolders={onClearHiddenFolders}
